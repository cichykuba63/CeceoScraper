...
porbanych zostało {stats["opinions_count"]} opinii.
Do {stats["pros_count"]} opinii podana została lista zalet produktu, 
...
score = opinions.score.value_counts().reindex(list(np.arange(0, 5.5, .5)), fill_value=0)
print(score)
score.plot.bar()
